...
<div class="content-wrapper">
    <div class="content-tabs hide">
        ...
        <nav class="page-tabs J_menuTabs" id="rftags">
            <div class="page-tabs-content">
                <a href="javascript:void (0);" class="active J_menuTab" data-id="<?= Url::to(['/main/system']); ?>"
                   id="rftagsIndexLink">首页</a>
        ...
        <a href="<?= Url::to(['site/logout']); ?>" data-method="post" class="roll-nav roll-right J_tabExit"><i
    ...
    <div class="J_mainContent" id="content-main">
        ...
        <iframe class="J_iframe" name="iframe0" width="100%" height="100%"
                src="<?= Url::to(Yii::$app->services->menu->getOnAuthList()[0]['-'][0]['url'] ?? Yii::$app->params['adminDefaultHomePage']); ?>"
                frameborder="0" data-id="<?= Url::to(Yii::$app->params['adminDefaultHomePage']); ?>" seamless></iframe>
    </div>
</div>